...
public class Mario extends GameObject {
    ...
    public double SlowDistance = Math.PI;
...
//        g.scale(1.3, 1.3);// 800 x 600
//                    g.scale(1.6, 1.6);// 1024 x 768
...
//        player.Grow();
        ...
        if (this.LevelNumber == 10) { // start screen
            ...
            if (this.CurrentLevel.attribute == null ? "Clowd" == null : this.CurrentLevel.attribute.equals("Clowd")) {
            ...
            if (FlyingFishes & player.getX() < FlyingFishesLength & player.getX() > 20 * 32) {
                ...
                if (FlyingFishesGroup.getSize() < 10) {
                    if (FlyingFishesdelay < 0) {
                        ...
                        Random r = new Random();
                        FlyingFishesdelay = r.nextInt(100) + 120;
                    }

                    if (FlyingFishesdelay > -20) {
                        FlyingFishesdelay--;
                    }
...
//        if(player.getScreenX()+16 > this.getWidth()/2){
            ...
            if (this.SmoothScroll) {
                if (this.player.getScreenX() > 320) {
                    this.color_background.move(3, 0);
                }
            }
//            
...
//                    InvertDistance = 0;
                ...
                // 6.283185307179586 = pi x 2
                // Math.PI * 2

                if (InvertDistance < -63) {
                    InvertDistance = 0.00;
                }
                if (SlowDistance > 63) {
                    SlowDistance = 0.00;
                }
//                System.out.println(InvertDistance);
...
//         if (this.bsInput.isKeyDown(KeyEvent.VK_A)) {
//            if(scaleOn){
//                scaleOn = false ;
//            }else{
//                scaleOn = true ;
...
//                                    // System.out.println("grass " + i +" "+ constr.getX() + " "+constr.getY());
                            ...
                            case 12: // pump
                                if (y == 0) { // pump top with plant
                                    ...
                                    if (!"OrangePump".equals(CurrentLevel.level_Name)) { // all plants to all levels except "C42" which is clowd bonus level in 4-2 world
                                    ...
                                    if ("Sea".equals(CurrentLevel.attribute)) {
                                        ...
                                        BrickGroup.add(new pump(this.bsLoader.getStoredImage("pump top Castle.png"), (constr.getX() * 32) + (x * 32), (constr.getY() * 32) + (y * 32), this));

                                    } else if ("OrangePump".equals(CurrentLevel.level_Name)) {
                                        BrickGroup.add(new pump(this.bsLoader.getStoredImage("OrangeTopPump.png"), (constr.getX() * 32) + (x * 32), (constr.getY() * 32) + (y * 32), this));
                                        // OrangeAndMushroom
                                        System.out.println("terer");
//                                        BrickGroup.add(new pump(this.bsLoader.getStoredImage("OrangePump.png"), (constr.getX() * 32) + (x * 32), (constr.getY() * 32) + (y * 32), this));
                                    ...
                                    if ("Sea".equals(CurrentLevel.attribute)) {
                                        ...
                                        BrickGroup.add(new pump(this.bsLoader.getStoredImage("pump Castle.png"), (constr.getX() * 32) + (x * 32), (constr.getY() * 32) + (y * 32), this));
...
//                                             BrickGroup.add(new Sprite()); // empty no trunks
                                ...
                                } else if ("GreenAndTrees".equals(CurrentLevel.type)) { // green trees
...
//                                      BrickGroup.add(new WhyYouDOThis((constr.getX()*32)+ (x*32),  (constr.getY()*32)+ (y*32) , this.bsLoader.getStoredImages("WhyYouDOThis"), this  ) );
                            ...
                            case 41: // Fire
                                ...
                                HammerGroup.add(new BossFire((int) (constr.getX() * 32) + (x * 32), (int) (constr.getY() * 32) + (y * 32), bsLoader.getStoredImages("BossFire")));
    ...
    private void LoadCheckPoints(BasicLevel CurrentLevel) {
        ...
        for (int i = 0; i < 20; i++) { // how many items
            ...
            if (CurrentLevel.get_CheckPoints_Number(i) != null) { // dont throw null exception error
                ...
                CheckPoints checkpoint = CurrentLevel.get_CheckPoints_Number(i);

//                    if(cp.getID() == 23){
//                        cp.setImage(this.getImage("chocolate_Sea.png"));
//                    }
//                    else 
                if (checkpoint.getID() == 16) {
                    checkpoint.setImage(this.getImage("WhyYouDOThis.png"));
                } else if (checkpoint.getID() == 26) {
                    checkpoint.setImage(this.bsLoader.getStoredImage("Princess.png"));
                } else if (checkpoint.getID() == 27) { // long clowd check point
//                    checkpoint.setImage(this.bsLoader.getStoredImage("clowd_checkpoint.png")); // made visible for testing purpuse
                    checkpoint.setImage(ImageUtil.createImage(640, 64, 3));
                } else if (checkpoint.getID() == 28) { // long clowd check point
                    checkpoint.setImage(this.bsLoader.getStoredImage("Clowd.png"));
                } else {
                    checkpoint.setImage(ImageUtil.createImage(32, 32, 3));
                }
                this.FlagGroup.add(checkpoint);
...
//        font.drawString(g ,"X  "+(int)player.getX()/32 + " Y "+(int)player.getY()/32, 21, 64 );
    ...
    private void LoadInvisibleObjects() {
        switch (this.LevelNumber) {
            ...
            case 14:
                ;
                Sprite noscroll2 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 24:
                ;
                Sprite noscroll3 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 33:
                ...
                break;
            case 34:
                Sprite noscroll4 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 43:
                ...
                break;
            case 44:
                Sprite noscroll5 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 54:
                ;
                Sprite noscroll6 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 64:
                ;
                Sprite noscroll7 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
                ...
                this.InvisibleObjects.add(scroll7);
                ;
                break;
            ...
            case 73:
                ...
                break;
            case 74:
                Sprite noscroll8 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
            ...
            case 844:
                ...
                break;
            case 845:
                Sprite noscroll9 = new Sprite(ImageUtil.createImage(1 * 32, 7 * 32));
